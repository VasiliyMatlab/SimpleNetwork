...
<a name="States">Клиенты находятся в одном из следующих состояний (или их комбинации)</a>:
...
- "Set client #M state: STATE" - перевод клиента M в состояние <a href="https://github.com/VasiliyMatlab/SimpleNetwork/edit/master/README.md/#States">STATE</a>
